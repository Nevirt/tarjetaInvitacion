...
function Hero() {
  ...
  return (
    ...
    >
      ...
      {config.elements?.hero?.showBubbles !== false && <FloatingBubbles />}
      ...
      {config.elements?.hero?.showFlowerTopLeft !== false && (
      ...
      {config.elements?.hero?.showFlowerBottomLeft !== false && (
      ...
      {config.elements?.hero?.showFlowerTopRight !== false && (
      ...
      {config.elements?.hero?.showGoldenDivider !== false && (
      ...
      >
        ...
        {config.elements?.hero?.showGoldenFrame !== false && (
          <motion.div
